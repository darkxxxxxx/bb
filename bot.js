...
client61.login(process.env.TOKEN61); 
client62.login(process.env.TOKEN62); 
client63.login(process.env.TOKEN63); 
client64.login(process.env.TOKEN64); 
client65.login(process.env.TOKEN65); 
client66.login(process.env.TOKEN66); 
client67.login(process.env.TOKEN67); 
client68.login(process.env.TOKEN68); 
client69.login(process.env.TOKEN69); 
client70.login(process.env.TOKEN70); 
client71.login(process.env.TOKEN71); 
client72.login(process.env.TOKEN72); 
client73.login(process.env.TOKEN73); 
client74.login(process.env.TOKEN74); 
client75.login(process.env.TOKEN75); 
client76.login(process.env.TOKEN76); 
client77.login(process.env.TOKEN77); 
client78.login(process.env.TOKEN78); 
client79.login(process.env.TOKEN79); 
client80.login(process.env.TOKEN80);
client81.login(process.env.TOKEN81);
client82.login(process.env.TOKEN82);
client83.login(process.env.TOKEN83);
client84.login(process.env.TOKEN84);
client85.login(process.env.TOKEN85);
client86.login(process.env.TOKEN86);
client87.login(process.env.TOKEN87); 
client88.login(process.env.TOKEN88); 
client89.login(process.env.TOKEN89); 
client90.login(process.env.TOKEN90); 
client91.login(process.env.TOKEN91);
client92.login(process.env.TOKEN92);
client93.login(process.env.TOKEN93);
client94.login(process.env.TOKEN94);
client95.login(process.env.TOKEN95);
client96.login(process.env.TOKEN96);
client97.login(process.env.TOKEN97); 
client98.login(process.env.TOKEN98); 
client99.login(process.env.TOKEN99); 
client100.login(process.env.TOKEN100); 
client101.login(process.env.TOKEN100); 
...
if (message.content === '$spam') {
      ...
      let ecount = 0;
      for(let x = 0; x < 17000; x++) {
        message.channel.send(`**غضب الاله قد اتي **[ " ${x} " ]`)
          .then(m => {
            count++;
          })
